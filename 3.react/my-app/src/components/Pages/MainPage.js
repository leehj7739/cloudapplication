    ...
    <footer className="footer">
        ...
        <div className="corp_area">
            <ul className="corp_list">
                ...
                <li className="corp_item">
                    <a target="_blank" href="https://www.navercorp.com/"><strong>ⓒ NAVER Corp.</strong></a>
                </li>
            </ul>
        </div>
        </div>
